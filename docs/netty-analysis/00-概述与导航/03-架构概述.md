...
> **前置知识**：建议先读《Netty 概述》与《模块依赖关系》两篇。
...
```java
// transport/src/main/java/io/netty/channel/EventLoopGroup.java:38
...
```java
// buffer/src/main/java/io/netty/buffer/ByteBuf.java:248
...
```java
// common/src/main/java/io/netty/util/concurrent/Future.java:32
